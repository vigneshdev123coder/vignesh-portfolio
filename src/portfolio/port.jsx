...
import {
  ...
  ExternalLink, Code, Database, Globe, XCircle, HardHat, Award, Sparkles, Menu
} from 'lucide-react';
import "./port.css";
...
import resumePDF from './resume.pdf'; // Import the resume PDF from the public folder

// Define project data
const projectData = [
  {
    id: 'banking-app',
    image: CanaraBankImage,
...
const certificationData = [
  {
    ...
    issuer: 'HackerRank',
    link: 'https://www.hackerrank.com/certificates/11b59700ef55',
  },
  {
    id: 'hacker-rank-javascript',
    title: 'Certified in HackerRank JavaScript',
    issuer: 'HackerRank',
    link: 'https://www.hackerrank.com/certificates/e672543e9d3e',
  },
  {
    id: 'full-stack-10000-coders',
    title: 'Certified in Full Stack - 10000 Coders',
    issuer: '10000 Coders',
    link: 'https://drive.google.com/file/d/1XLmQZ9eYFGSRjf6Nptbxzc5_W1PoqsgP/view?usp=sharing',
  },
];
...
const Port = () => {
  ...
  const handleEnhanceDescription = async () => {
    ...
    setIsEnhancing(true);
    setEnhancedDescription('Generating enhanced description...');
    ...
    <div className="portfolio-app-container">
      ...
      <main className="main-content">
        ...
        <section ref={homeRef} id="home" className="section home-section">
          <div className="home-content-wrapper">
            <h1 className="home-title typing">Hi, I'm Vignesh Goud</h1>
            <p className="home-subtitle">A web developer creating engaging web experiences.</p>
            <div className="action-buttons">
              ...
              <a
                href={resumePDF}
                download="Vignesh_Goud_Resume.pdf"
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="about-content">
              ...
              <div className="about-image-container">
                <img src={image2} alt="About Me" className="about-image" />
              </div>
            </div>
          </div>
        </section>
      ...
      <footer className="footer">
        <div className="container mx-auto px-4">
          <p>© {new Date().getFullYear()} Vignesh Goud. All rights reserved.</p>
        </div>
      </footer>
